...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(512, 2048), ratio_range=(0.8, 2.0), keep_ratio=True),
    dict(type='RandomCrop', crop_size=(512,2048)),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file= './datasets/ADEChallengeData2016/ade20k_panoptic_train_detection_format.json',
        img_prefix='./datasets/ADEChallengeData2016/images/training',
    ...
    #    pipeline=train_pipeline),
    val=dict( 
        img_info_file_folder = './datasets/ADEChallengeData2016/ade20k_panoptic_val_detection_format.json',
        output_folder = 'seg',
        pred_json = 'pred.json',
