...
class CityscapesDataset_plus(CustomDataset):
    ...
    def __init__(self,
            ...
            img_info_file_folder = './datasets/cityscapes/cityscapes_panoptic_val_detection_format.json',
            output_folder = 'seg',
            pred_json = 'pred.json',
            segmentations_folder='seg',
            gt_json = './datasets/cityscapes/cityscapes_panoptic_val_detection_format.json',
            gt_folder = '/datasets/cityscapes/cityscapes_panoptic_val',
            **kwarags):
            ...
            super(CityscapesDataset_plus,self).__init__(**kwarags)
    def load_annotations(self, ann_file):
        ...
        for i in self.img_ids:
            ...
            file_name = osp.join(info['file_name'].split('_')[0],info['file_name'])
    ...
    def evaluate(self,
        ...
        if 'panoptic' in metrics:
            ...
            pq_compute2(self.gt_json,panoptic_result, self.gt_folder, self.segmentations_folder,logger=logger)
