...
class AttentionTail(nn.Module):
    ...
    def forward(self, query, key, key_padding_mask,hw_lvl=None):
        ...
        print(am.shape)
        save_tensor(am,'ptt_9_stuff.png',convert=True)'''
...
class Block(nn.Module):
    ...
    def __init__(self, cfg,dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.self_attention = SelfAttention(cfg,dim,num_heads=num_heads,qkv_bias=qkv_bias,qk_scale=qk_scale,attn_drop=attn_drop,proj_drop=drop)
...
class TransformerHead14(nn.Module):
