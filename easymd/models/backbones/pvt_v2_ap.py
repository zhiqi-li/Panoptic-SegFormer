...
class PyramidVisionTransformerImpr(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 attn_drop_rate=0., drop_path_rate=0.,out_indices=[1,2,3], norm_layer=nn.LayerNorm,
...
class pvt_v2_b0_ap(PyramidVisionTransformerImpr):
    def __init__(self, out_indices=[1,2,3],**kwargs):
        super(pvt_v2_b0_ap, self).__init__(
            patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1, out_indices=out_indices,pretrained=kwargs['pretrained'])


@BACKBONES.register_module()
class pvt_v2_b1_ap(PyramidVisionTransformerImpr):
    def __init__(self,out_indices=[1,2,3], **kwargs):
        super(pvt_v2_b1_ap, self).__init__(
...
@BACKBONES.register_module()
class pvt_v2_b2_ap(PyramidVisionTransformerImpr):
    def __init__(self, out_indices=[1,2,3],**kwargs):
        print(kwargs)
        super(pvt_v2_b2_ap, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
