...
class SamplingResult_w_mask(util_mixins.NiceRepr):
    ...
    def __init__(self, pos_inds, neg_inds, bboxes, gt_bboxes, masks,gt_masks,assign_result,
                 gt_flags):
...
class SamplingResult_w_mask2(util_mixins.NiceRepr):
    """Bbox sampling result.
...
class SamplingResult_w_mask3(util_mixins.NiceRepr):
    """Bbox sampling result.
    ...
    def __init__(self, pos_inds, neg_inds, gt_masks,assign_result,
                 gt_flags):
        self.pos_inds = pos_inds
        self.neg_inds = neg_inds
        #self.pos_bboxes = bboxes[pos_inds]
